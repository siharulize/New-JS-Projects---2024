const global = {
   ...
   api: {
      apiKey: '286bbb55d72c14b84b3069397be70314',
   ...
   results.results.forEach(tv => {
      ...
      div.innerHTML = `
          ...
          <div class="card-body">
            ...
            <p class="card-text">
              <small class="text-muted">Release: ${tv.first_air_date
              }</small>
            </p>
...
//Displauy backdrop on details pages
...
async function fetchAPIData(endpoint){
   //not in production, on your server and make a call to it
...
//Fetch data from TMDB API for search
...
function highlightActiveLink(){
   ...
   links.forEach((link) => {
      if (global.currentPage.includes(link.getAttribute('href').slice(1))) {
